...
class Sms {
  ...
  createCommandList() {
    ...
    this.addCommand(
      commandList,
      "on",
      "Enables the user to receive calls.",
      "on",
      1,
      null,
      this.on.bind(this)
    ...
    this.addCommand(
      commandList,
      "off",
      "Disables the user from receiving calls.",
      "off",
      1,
      null,
      this.off.bind(this)
    ...
    this.addCommand(
      ...
      "add",
      "Adds a new user.",
      "add [password] [contact_uri] [username]",
      4,
      "addUser",
      this.add.bind(this)
    );
    ...
    this.addCommand(
      ...
      "changenumber [password] [old number] [new number]",
      4,
      "update",
    ...
    this.addCommand(
      commandList,
      "manual",
      "Gets help manual for a command, or lists all commands if used by itself.",
      "manual [command name]",
      2,
      null,
    ...
    this.addCommand(
      commandList,
      "status",
      "Gets status for user and system.",
      "status",
      1,
      null,
    ...
    this.addCommand(
      commandList,
      "setadminpassword",
      "Authorizes specified user for admin task and sets initial password.",
      "setadminpassword " +
        "[password] [username] [admin task] [initial password]",
      5,
      "identity",
      this.setAdminPassword.bind(this)
    );
    this.addCommand(
      commandList,
      "sendall",
      "Sends a text message to all users.",
      'sendall [password] "[message]"',
      3,
      "sendmessage",
      this.sendAll.bind(this)
    );
    this.addCommand(
      commandList,
      "sendusername",
      "Sends a text message to a user by name.",
      "sendusername " + '[password] [username] "[message]"',
      4,
      "sendmessage",
      this.sendUsername.bind(this)
    );
