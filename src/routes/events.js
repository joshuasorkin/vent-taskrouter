...
function voicemail(callSid) {
  var client = buildClient(),
    query = querystring.stringify({
      Message:
        "Sorry, All agents are busy. Please leave a message. We'll call you as soon as possible",
...
function notifyOfflineStatus(phone_number) {
  var client = buildClient(),
    message =
      'Your status has changed to Offline. Reply with "On" to get back Online';
  client.sendMessage({
    to: phone_number,
